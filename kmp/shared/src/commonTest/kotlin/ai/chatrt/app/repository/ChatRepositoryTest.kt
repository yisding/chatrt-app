...
class ChatRepositoryTest {
    ...
    @Test
    fun testObserveConnectionState() =
        runTest {
            val (repository, apiService, mockWebRtc) = createRepository()
            try {
                // When
    ...
    @Test
    fun testCreateCallUpdatesState() =
        runTest {
            val (repository, apiService, mockWebRtc) = createRepository()
            try {
                // Given
    ...
    @Test
    fun testWebRtcConnectionStateChanges() =
        runTest {
            val (repository, apiService, mockWebRtc) = createRepository()
            try {
                // Given
    ...
    @Test
    fun testStartConnectionMonitoring() =
        runTest {
            val (repository, apiService, mockWebRtc) = createRepository()
            try {
                // Given
    ...
    @Test
    fun testIceConnectionStateHandling() =
        runTest {
            val (repository, apiService, mockWebRtc) = createRepository()
            try {
    ...
    @Test
    fun testWebRtcInitializationError() =
        runTest {
            val (repository, apiService, mockWebRtc) = createRepository()
            try {
