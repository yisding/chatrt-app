...
class SettingsViewModelTest {
    ...
    @Test
    fun `updateDefaultVideoMode should update setting and show success`() = runTest {
    ...
    @Test
    fun `updateDefaultVideoMode with failure should set error`() = runTest {
    ...
    @Test
    fun `updateAudioQuality should update setting and show success`() = runTest {
        // Given - successful repository operation
    ...
    @Test
    fun `updateDefaultCamera should update setting and show success`() = runTest {
        // Given - successful repository operation
    ...
    @Test
    fun `toggleDebugLogging should toggle the setting`() = runTest {
    ...
    @Test
    fun `updateDebugLogging should update setting directly`() = runTest {
        // Given - successful repository operation
        mockSettingsRepository.setDebugLoggingResult(Result.success(Unit))
    ...
    @Test
    fun `updateServerUrl with valid URL should update setting`() = runTest {
        // Given - successful repository operation
    ...
    @Test
    fun `updateServerUrl with invalid URL should set error`() = runTest {
        // Given - invalid URL
    ...
    @Test
    fun `updateServerUrl with empty URL should be allowed`() = runTest {
        // Given - successful repository operation
        mockSettingsRepository.setServerUrlResult(Result.success(Unit))
    ...
    @Test
    fun `updateAllSettings should update complete settings object`() = runTest {
    ...
    @Test
    fun `validateServerUrl with valid URL should return success`() = runTest {
        // Given - valid URL
        val validUrl = "https://api.example.com"
    ...
    @Test
    fun `validateServerUrl with invalid URL should return failure`() = runTest {
        // Given - invalid URL
    ...
    @Test
    fun `getCurrentSettings should return current settings synchronously`() = runTest {
    ...
    @Test
    fun `isDebugLoggingEnabled should return current debug logging state`() = runTest {
        // Given - debug logging is initially false
        testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `getCurrentServerUrl should return current server URL`() = runTest {
    ...
    @Test
    fun `save success should auto-clear after delay`() = runTest {
    ...
    private class MockSettingsRepository : SettingsRepository {
        ...
        override suspend fun updateSettings(settings: AppSettings): Result<Unit> {
            return updateSettingsResult.onSuccess {
        ...
        override suspend fun setDefaultVideoMode(mode: VideoMode): Result<Unit> {
            return defaultVideoModeResult.onSuccess {
        ...
        override suspend fun setAudioQuality(quality: AudioQuality): Result<Unit> {
            return audioQualityResult.onSuccess {
        ...
        override suspend fun setDefaultCamera(camera: CameraFacing): Result<Unit> {
            return defaultCameraResult.onSuccess {
        ...
        override suspend fun setDebugLogging(enabled: Boolean): Result<Unit> {
            return debugLoggingResult.onSuccess {
