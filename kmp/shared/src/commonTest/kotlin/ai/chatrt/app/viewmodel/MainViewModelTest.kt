...
class MainViewModelTest {
    ...
    @Test
    fun `startConnection should update connection state to connecting`() =
        runTest {
            // Given - ViewModel is initialized
    ...
    @Test
    fun `startConnection with successful response should start monitoring`() =
        runTest {
    ...
    @Test
    fun `startConnection with failure should set error state`() =
        runTest {
    ...
    @Test
    fun `stopConnection should update state to disconnected`() =
        runTest {
    ...
    @Test
    fun `setVideoMode should update video mode and log change`() =
        runTest {
    ...
    @Test
    fun `handleSystemInterruption with phone call should pause call`() =
        runTest {
    ...
    @Test
    fun `handleSystemInterruption with network loss should set reconnecting state`() =
        runTest {
            // Given - active connection
            mockChatRepository.emitConnectionState(ConnectionState.CONNECTED)
            testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `resumeAfterInterruption should resume paused call`() =
        runTest {
    ...
    @Test
    fun `handleNetworkQualityChange should update network quality and suggest optimization for poor network`() =
        runTest {
    ...
    @Test
    fun `handleResourceConstraints with low memory should suggest optimization`() =
        runTest {
    ...
    @Test
    fun `applyPlatformOptimization should apply recommended settings and clear optimization`() =
        runTest {
    ...
    @Test
    fun `dismissOptimization should clear optimization suggestion`() =
        runTest {
    ...
    @Test
    fun `logs should be limited to 100 entries`() =
        runTest {
    ...
    private class MockChatRepository : ChatRepository {
        ...
        override suspend fun createCall(callRequest: CallRequest): Result<CallResponse> = createCallResult
        ...
        override suspend fun stopConnection(): Result<Unit> = stopConnectionResult
