...
class SettingsRepositoryTest {
    ...
    @Test
    fun testObserveSettings() = runTest {
        val repository = createRepository()
        // When
    ...
    @Test
    fun testSetDefaultVideoMode() = runTest {
        val repository = createRepository()
        // Given
    ...
    @Test
    fun testSetAudioQuality() = runTest {
        val repository = createRepository()
        // Given
    ...
    @Test
    fun testSetDefaultCamera() = runTest {
        val repository = createRepository()
        // Given
    ...
    @Test
    fun testSetDebugLogging() = runTest {
        val repository = createRepository()
        // Given
    ...
    @Test
    fun testSettingsFlowUpdates() = runTest {
        val repository = createRepository()
        // Given
        val settingsFlow = repository.observeSettings()
        val initialSettings = settingsFlow.first()
