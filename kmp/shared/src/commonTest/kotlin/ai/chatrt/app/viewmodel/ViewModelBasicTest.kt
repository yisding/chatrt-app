...
class ViewModelBasicTest {
    ...
    @Test
    fun `MainViewModel initial state should be correct`() = runTest {
    ...
    @Test
    fun `SettingsViewModel initial state should be correct`() = runTest {
        // Then - initial state should be correct
    ...
    @Test
    fun `MainViewModel setVideoMode should update video mode`() = runTest {
    ...
    @Test
    fun `MainViewModel should handle network quality changes`() = runTest {
    ...
    @Test
    fun `MainViewModel should handle system interruptions`() = runTest {
    ...
    @Test
    fun `SettingsViewModel getCurrentSettings should return current settings`() = runTest {
    ...
    @Test
    fun `SettingsViewModel isDebugLoggingEnabled should return current state`() = runTest {
    ...
    @Test
    fun `SettingsViewModel clearError should clear error state`() = runTest {
    ...
    @Test
    fun `MainViewModel clearError should clear error state`() = runTest {
    ...
    @Test
    fun `MainViewModel should log video mode changes`() = runTest {
    ...
    private class MockChatRepository : ChatRepository {
        ...
        override suspend fun createCall(callRequest: CallRequest): Result<CallResponse> {
            return Result.success(CallResponse("test-id", "test-sdp", "success"))
        }
