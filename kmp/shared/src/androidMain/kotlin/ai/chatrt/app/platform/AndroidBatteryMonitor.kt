...
class AndroidBatteryMonitor(
    ...
    override suspend fun isBatteryLow(): Boolean {
        return getCurrentBatteryLevel() < 20
    }
    ...
    override suspend fun getBatteryState(): ai.chatrt.app.platform.BatteryState {
    ...
    override suspend fun getPowerSavingRecommendation(): PowerSavingRecommendation? {
        ...
        return when {
            batteryLevel < 15 && !isCharging -> PowerSavingRecommendation(
                mode = PowerSavingMode.AGGRESSIVE,
                reason = "Battery critically low",
                estimatedBatteryGain = "30-60 minutes"
            )
            batteryLevel < 30 && !isCharging -> PowerSavingRecommendation(
    ...
    private fun createInitialBatteryState(): ai.chatrt.app.platform.BatteryState {
        ...
        val powerSavingMode = if (powerManager.isPowerSaveMode) {
